...
const Location: React.FC = () => {
  return (
    <div className="flex flex-col items-center p-8 bg-black">
      <h1 className="text-4xl font-extrabold text-white mb-2 animate-fadeIn tracking-wide text-center">
        <span>She</span><span className="text-fuchsia-500">Code</span> Location
      </h1>

      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1418 125" fill="#fff" className="w-full max-w-4xl h-6 mb-8">
      ...
      <div className="w-full max-w-6xl h-96 rounded-xl overflow-hidden shadow-2xl">
        <LoadScript googleMapsApiKey="GOOGLE_MAP_API_KEY_GOES_HERE"> /* API KEY GOES HERE */
          <GoogleMap
            mapContainerStyle={mapContainerStyle}
            center={center}
            zoom={18}
          >
            <Marker position={{ lat: 38.792397, lng: -90.001111 }} />
            <InfoWindow position={{ lat: 38.792397, lng: -90.001111 }}>
              <div>
                <strong>SIUE School of Engineering</strong><br />
                61 S Circle Dr, Edwardsville, IL 62026
              </div>
            </InfoWindow>
          </GoogleMap>
        </LoadScript>
