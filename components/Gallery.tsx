...
const images = [
  { url: '/assets/image5.jpg', alt: 'Programmer working', width: 300, height: 240, col: 'col-span-1 sm:col-span-1' },
  { url: '/assets/image2.jpg', alt: 'Code on screen', width: 300, height: 220, col: 'col-span-1 sm:col-span-1' },
  { url: '/assets/image3.jpg', alt: 'Laptop with code', width: 250, height: 200, col: 'col-span-1 sm:col-span-1' },
  { url: '/assets/image1.jpg', alt: 'Multiple screens with code', width: 560, height: 150, col: 'col-span-2 sm:col-span-1' },
  { url: '/assets/image4.jpg', alt: 'Coding interface', width: 260, height: 150, col: 'col-span-1 sm:col-span-1' },
];

const Gallery: React.FC = () => {
  return (
    <div id="gallery" className="flex justify-center items-center min-h-screen bg-black p-4 sm:p-8">
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-4xl">
        {images.map((image, index) => (
          ...
          >
            ...
            />
            {index === 1 && (
              <div className="absolute left-1 top-[150px] sm:top-auto sm:left-auto sm:-top-20 sm:right-12 flex items-center mt-4 sm:mt-3">
